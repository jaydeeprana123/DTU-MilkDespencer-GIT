...
public interface TransactionDao {
    ...
    int updateTransactionDetails(String id, float volume, String milkPrice, String milkTemperature, String transactionStatus, float remainingVolume, String transactionDate, String transactionTime);
