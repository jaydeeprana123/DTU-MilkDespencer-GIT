...
public class MainActivity1 extends AppCompatActivity implements UsbSerialCommunication.ReadDataListener {
...
*/
            ...
            preferencesManager = SharedPreferencesManager.getInstance(MainActivity1.this);
...
//                usbSerialCommunication.disconnect();
        ...
        btnPayWithQr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MainActivity1.this, PayWithQrActivity.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.action_Config) {
            ...
            // Handle edit action
            Constants.showLoginDialog(MainActivity1.this, appDatabase);
